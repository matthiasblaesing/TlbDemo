 ...
 * end shuts down word. The prcess creates a PDF document, that is written to a
 * temporary file, which name is printed.</p>
 */
public class Automation_KB_313193_Mod {
    public static void main(String[] args) throws IOException {
        ...
        try {
            ...
            Path tempFile = Files.createTempFile("KB_313193_", ".pdf");
            ...
            System.out.println("Output written to: " + tempFile.toAbsolutePath().toString());
