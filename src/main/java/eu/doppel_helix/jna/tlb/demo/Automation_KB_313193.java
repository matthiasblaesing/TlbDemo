...
import eu.doppel_helix.jna.tlb.office2.XlChartType;
...
import eu.doppel_helix.jna.tlb.word8.Paragraph;
import eu.doppel_helix.jna.tlb.word8.Range;
import eu.doppel_helix.jna.tlb.word8.Table;
import eu.doppel_helix.jna.tlb.word8.WdBreakType;
import eu.doppel_helix.jna.tlb.word8.WdCollapseDirection;
import eu.doppel_helix.jna.tlb.word8.WdInformation;


/**
 * Based on VB sample: https://support.microsoft.com/de-de/kb/313193
 * 
 * <p>This demo creates a sample document with word visible while doing so,
 * keeping it open at the end.</p>
 * 
 * <p>The application is run visible and user could interact - in production
 * this is probably not wanted (omit the setVisible call).</p>
 */
public class Automation_KB_313193 {
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            Document doc = wordApp.getDocuments().Add(VARIANT_MISSING, VARIANT_MISSING,
